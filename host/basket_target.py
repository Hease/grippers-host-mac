...
#
# 2026-09-07 — 사용자 지시로 더 늘린다("75도도 더 올린다"). 위 90도 상한
# 취지(완전히 옆을 보면 방향 자체가 의미 없어진다)는 그대로 지키되, 75도보다
# 더 여유를 준다. 85도는 아직 실기로 확인된 적이 없다 — 다음 실행에서
# 이 문턱 근처(75~85도)로 들어오는 사례가 있으면 INSERT 결과를 지켜볼 것.
MAX_FACING_ERROR_DEG = 85.0
